...
namespace XWIN.Handlers.Processes
{
    using Models;
    using Foundation;
    using Utilities;
    ...
    public class TunnelProcess
    {
        ...
        private const string X_TUN_PROCESS = "X-TUN";
        ...
        public void Start()
        {
            ...
            processor.StopSystemProcesses(X_TUN_PROCESS);

            processor.StartProcess(
                processName: X_TUN_PROCESS,
                fileName: System.IO.Path.GetFullPath(Path.XTUN_EXE),
        ...
        public bool IsProcessRunning() => processor.IsProcessRunning(X_TUN_PROCESS);
